...
public class AssetController extends BaseController {
  ...
  @GetMapping
  public Response<List<AssetResponse>> retrieveLastNAssets(@Valid @RequestParam("lastN") @NotNull @Positive Integer size) {
    final List<Asset> assets = assetService.retrieveLastNAssets(size);
    return respond(AssetResponse.fromModel(assets));
  }

  @DeleteMapping("/{name}")
  public Response<Void> deleteByName(@Valid @PathVariable @NotNull @NotEmpty String name) {
